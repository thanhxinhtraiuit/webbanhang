        ...
        <div class="row no-gutters align-items-center pt-60px">
          <div class="col-5 d-none d-sm-block">
            <div class="hero-banner__img">
              <img class="img-fluid" src="{{ asset('upload/hero-banner.png') }}" alt="">
            </div>
          </div>
    ...
    <section class="section-margin calc-60px">
      <div class="container">
       ...
       <div class="row" id='lastnew'>
        ...
        <button class='btn btn-link loadmore' page='0' url='{{ route('loadmore') }}'>LoadMore</button>
      </div>
    </section>
    <!-- ================ Last New item  carousel end ================= --> 
