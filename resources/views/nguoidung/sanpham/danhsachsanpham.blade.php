...
@section('sitemain')
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
          ...
          <div class="filter-bar d-flex flex-wrap align-items-center">
            <div class="sorting">
              <select id='select-sx'>
                <option type='button' id='asc' url='{{ route('GetAsc') }}'>Giá Từ Thấp Đến Cao</option>
                <option type='button' id='desc'  url='{{ route('GetDesc') }}'>Giá Từ Cao Đến Thấp</option>
  ...
  <input type="hidden" id='iddanhmuc' value={{ $iddanhmuc }}>
	<!-- ================ Subscribe section end ================= -->		  
  @section('scripts')
      <script src='{{ asset('nguoidung/js/sanpham.js') }}'>   </script>
  @endsection
